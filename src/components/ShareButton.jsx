          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold bg-gradient-to-r from-slate-800 to-slate-500 dark:from-white dark:to-slate-400 bg-clip-text text-transparent">
                  Compartilhar
                </h3>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <div className="relative">
                <div className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700">
                  <div className="flex-1 truncate text-sm text-slate-500 dark:text-slate-400 select-all" title={fullUrl}>
                    {fullUrl}
                  </div>
                  <button
