      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute top-14 right-0 md:-right-[64px] w-[320px] bg-[var(--bg-color)] p-4 shadow-2xl z-50 border border-slate-700/50 rounded-2xl transition-colors duration-300 origin-top-right"
          >
